...
function arrayContiene(array, elemento) {
   ...
   // Tu código:
   var includeELemento=array.includes(elemento);
   return includeELemento;
...
function numeroMasGrande(arrayOfNums) {
   ...
   for(let i=0;i<arrayOfNums.length;i++){
      if(arrayOfNums[i-1]<arrayOfNums[i]||arrayOfNums[i]>arrayOfNums[i+1]){
